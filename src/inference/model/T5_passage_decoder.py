...
class deT5ForConditionalGeneration(T5ForConditionalGeneration):
    ...
    def forward(
        ...
        decoder_input_tensor: Optional[torch.FloatTensor] = None,
        ...
        if decoder_input_tensor!=None:
            new_hidden_states = torch.cat((decoder_input_tensor,hidden_states), dim=1)
        else:
